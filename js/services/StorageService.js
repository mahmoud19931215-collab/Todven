// ==================== خدمة التخزين باستخدام Dexie + LocalStorage Fallback ====================
...
export class StorageService {
    ...
    // الحصول على وقت آخر تحديث من الكاش (للبانر)
    getLastUpdateTimestamp() {
        if (this.useFallback) {
            ...
            // يمكن قراءة من IndexedDB بشكل متزامن؟ الأفضل أن تكون غير متزامن، لكننا سنعيد null هنا
            return null;
        }
        return null;
    }
